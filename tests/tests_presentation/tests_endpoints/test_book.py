...
def test_get_route_book_with_valid_book_return_book(
	test_client: TestClient, valid_headers: dict, created_book: BookDomain
):
	url = "/book"
...
def test_put_route_book_with_valid_data_return_200(
	test_client: TestClient, valid_headers: dict, created_book: BookDomain
):
	url = "/book"
	headers = valid_headers
...
def test_delete_route_book_with_valid_book_id_return_200(
	test_client: TestClient, valid_headers: dict, created_book: BookDomain
):
	url = "/book"
	headers = valid_headers
